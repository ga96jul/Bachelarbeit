...
The type of fading used is called Rayleigh fading, also mentionend before in chapter \eref{sec:rayleigh}. For the whole block fading simulation two different scenarios will be considered:
\newline
