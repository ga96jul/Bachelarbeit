...
xmajorgrids,
ymajorgrids,
legend style={at={(0.18,0.669)}, anchor=south west, legend cell align=left, align=left, draw=white!15!black}
]
...
\addplot [color=blue, draw=none, mark size=5.0pt, mark=asterisk, mark options={solid, blue}]
  table[row sep=crcr]{%
8.4925	2\\
};
